  ...
  const releases = [
    {
      ...
      summary:
        "PDF Pro today announced a groundbreaking update to its platform, integrating advanced AI to automatically summarize, categorize, and extract key data from PDF documents, setting a new standard for document intelligence.",
    },
    {
      date: "August 15, 2025",
      title: "PDF Pro Surpasses 10 Million Users Worldwide",
      summary:
        "Celebrating a major milestone, Pdf works now serves over 10 million users, solidifying its position as a leading provider of online document solutions. The company attributes its rapid growth to its user-friendly design and powerful feature set.",
    },
    {
      date: "June 5, 2025",
      title:
        "New Partnership with Dropbox and Google Drive Enhances Cloud Integration",
      summary:
        "PDF Pro announces seamless integration with Dropbox and Google Drive, allowing users to directly import, edit, and save their documents from their favorite cloud storage providers without leaving the platform.",
    },
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="mt-4 text-lg text-gray-600">
            The latest news, announcements, and media resources from Pdf Works.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          >
            ...
            <p className="text-gray-600">
              Download our media kit for logos, brand guidelines, and other
              assets.
            </p>
