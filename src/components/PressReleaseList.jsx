          ...
          <div key={press._id} className="col-lg-6 col-xl-4 mb-4">
            <div className="card h-100 shadow-sm border-0 hover-shadow">
              ...
              <div className="card-body d-flex flex-column">
                <div className="mb-2">
                  <span className="badge bg-primary me-2">{press.category}</span>
                  <span className={`badge ${press.status === 'published' ? 'bg-success' : 'bg-warning'}`}>
                    {press.status}
                  </span>
                </div>
                
                <h5 className="card-title fw-bold text-dark">{press.title}</h5>
                ...
                {press.pdfFile && (
                  <div className="mt-2 p-3 bg-light rounded">
                    <div className="d-flex align-items-center mb-2">
                      ...
                      <div>
                        <strong className="d-block">{press.pdfFileName}</strong>
                        <small className="text-muted">
                          {formatFileSize(press.fileSize)} • {press.downloadCount || 0} downloads
                        </small>
                      </div>
                    </div>
                  </div>
                  ...
                  {press.pdfFile && (
                    <a 
                      ...
                      onClick={() => {
                        ...
                        fetch(`${API_URL}/api/pressrelease/${press._id}/download`, {
                          method: 'POST'
                        });
                      }}
                    >
