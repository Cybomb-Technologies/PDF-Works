...
import { Search, Clock, Calendar, Tag, BookOpen, AlertCircle } from 'lucide-react';
  ...
  const fetchBlogs = async (search = '', tag = '') => {
    try {
      ...
      if (result.success) {
        ...
        const tags = [...new Set(result.data.flatMap(blog => blog.tags || []))];
        setAllTags(tags);
      } else {
        ...
        {filteredBlogs.length === 0 && !loading && !error ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredBlogs.map(blog => (
              ...
              >
                <article
                  className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow duration-300 cursor-pointer h-full flex flex-col"
                >
                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="flex items-center text-sm text-gray-500">
                          ...
                          {blog.formattedDate || new Date(blog.createdAt).toLocaleDateString()}
                        </span>
                      </div>
                    </div>
