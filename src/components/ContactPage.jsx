          ...
          >
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Mon-Fri from 09:00 AM to 05:00 PM
                </p>
                <p className="text-gray-600">Saturday: 10:00 AM – 4:00 PM</p>
                <a
                  href="tel:+91 9715092104"
                  className="text-purple-600 font-medium"
                >
                  +91 9715092104
                </a>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Cybomb Technologies Pvt Ltd</p>
                <p className="text-gray-600">
                  Prime Plaza No.54/1, 1st street, Sripuram colony,
                </p>
                <p className="text-gray-600">St.Thomas Mount, Chennai, India</p>
              </div>
            </div>
          </motion.div>
