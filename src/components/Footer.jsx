...
const Footer = () => {
 ...
 <footer className="bg-white/50 backdrop-blur-lg border-t border-purple-200/50 text-gray-800">
  <div className="max-w-7xl mx-auto px-6 py-12">
    ...
    {/* GRID LAYOUT UPDATED HERE */}
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.2fr_1fr_1fr_1fr_1.5fr] gap-8">
      ...
      <div className="space-y-4">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="text-2xl font-bold gradient-text">PDF Works</span>
        </Link>
        ...
        <div className="flex space-x-4">
          <a href="https://x.com/CybombTech" className="text-gray-500 hover:text-purple-600 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" fill="currentColor" className="w-5 h-5" style={{fontSize: '24px', marginTop:"2px"}} viewBox="0 0 16 16">
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm text-gray-600">
              ...
              Prime Plaza No.54/1, 1st street,<br />
              Sripuram colony, St. Thomas Mount,<br />
