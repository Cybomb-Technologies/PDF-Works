  ...
  useEffect(() => {
    const verifyPayment = async () => {
      ...
      try {
        ...
        const response = await fetch(`${API_URL}/api/subscription/verify-payment`, {
          method: 'POST',
          headers: {
        ...
        toast({
          ...
          description: error.message || "Failed to verify payment. Please contact support if the issue persists.",
          variant: "destructive",
        });
        navigate('/pricing');
      } finally {
