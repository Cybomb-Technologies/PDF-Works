        ...
        <div style={styles.card}>
          ...
          {activeTab === "profile" && (
            <div style={styles.grid}>
                  ...
                  <button
                    ...
                    onMouseLeave={(e) => {
                      e.target.style.background =
                        styles.avatarButton.background;
              ...
              <div>
                ...
                >
                  Keep your profile information up to date. This helps in
                  maintaining proper communication and account security.
                </p>
                ...
                >
                  ...
                  <p style={{ color: "#64748b", margin: 0 }}>
                    Today at 09:30 AM from IP 192.168.1.1
                  </p>
                </div>
            ...
            <div style={styles.grid}>
              ...
              <div>
                ...
                >
                  ...
                  <button style={{ ...styles.button, background: "#0369a1" }}>
                    Enable 2FA
                  </button>
                </div>
              </div>
          ...
          {activeTab === "notifications" && (
            <div style={styles.grid}>
              ...
              <div>
                ...
                >
                  Control how and when you receive notifications. You can
                  customize your preferences for different types of alerts and
                  updates.
                </p>
                ...
                >
                  ...
                  <p style={{ color: "#64748b", margin: 0 }}>
                    Last notification sent: Today at 08:45 AM
                  </p>
                </div>
              </div>
            </div>
          ...
          {activeTab === "preferences" && (
            <div style={styles.grid}>
              ...
              <div>
                ...
                >
                  Customize how the admin panel looks and behaves according to
                  your preferences. These settings affect your personal view
                  only.
                </p>
                ...
                >
                  ...
                  <p style={{ color: "#64748b", margin: 0 }}>
                    Customize your dashboard with quick action buttons for
          ...
          <div style={styles.dangerZone}>
            ...
            <div style={{ display: "flex", gap: "15px", flexWrap: "wrap" }}>
              <button style={styles.dangerButton}>Clear All Data</button>
              <button style={styles.dangerButton}>Deactivate Account</button>
