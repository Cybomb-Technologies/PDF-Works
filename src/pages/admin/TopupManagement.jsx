...
const TopupManagement = () => {
  ...
  const fetchPackages = async () => {
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to fetch topup packages",
        variant: "destructive",
      });
    } finally {
  ...
  const handleSavePackage = async (pkg) => {
    ...
    try {
      ...
      if (res.ok) {
        toast({
          title: "Success",
          description: `Package ${pkg._id ? "updated" : "created"} successfully`,
        });
        fetchPackages();
        setEditingPkg(null);
  ...
  const initializeDefaults = async () => {
    ...
    try {
      ...
      if (res.ok) {
        toast({ title: "Success", description: "Default packages initialized" });
        fetchPackages();
      } else {
